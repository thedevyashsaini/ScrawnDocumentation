...
### 1. Don't Await Events Inline
To avoid blocking your response, start event tracking early and await at the end:
...
app.post('/api/generate', async (req, res) => {
  ...
  // Start event tracking (don't await yet) // [!code ++]
  ...
  // Wait for tracking to complete before responding // [!code ++]
...
### 2. Track Events After Service Delivery
Track usage as soon as the service is consumed:

```typescript
// Good - Track immediately after service delivery
